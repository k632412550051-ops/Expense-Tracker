...
(function() {
  ...
  const TRANSLATIONS = {
    vi: {
      ...
      aboutSecurityBox: "Bảo mật thông tin của bạn: Dữ liệu của bạn được bảo vệ tuyệt đối, không chia sẻ cho bất kỳ ai và tuân thủ đúng",
    ...
    en: {
      ...
      aboutSecurityBox: "Your Privacy Matters: Your financial records are strictly protected, never sold, and comply with our",
    ...
    ja: {
      ...
      aboutSecurityBox: "プライバシー保護方針：ユーザーデータは安全に保護され、第三者に共有されることはありません。",
    ...
    ko: {
      ...
      aboutSecurityBox: "개인정보 보호 약속: 사용자의 금융 정보는 철저히 보호되며 외부에 공유되지 않습니다.",
    ...
    zh: {
      ...
      aboutSecurityBox: "您的隐私受严格保护：数据绝不对外共享，严格遵守我们的",
